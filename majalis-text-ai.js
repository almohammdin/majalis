...
const ACTIONS=['none','navigate','focus','propose_field','propose_agenda','propose_participant','validate','explain'];
...
لا تقل تم قبل أن تنفذ الأداة في التطبيق. أي تعديل يعرض للمستخدم للموافقة أولا.
