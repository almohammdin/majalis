...
load('./majalis-decision-card-v1151.js?v=1.15.8',()=>load('./majalis-decision-result.js?v=1.15.8',()=>load('./majalis-voting-fix-v1153.js?v=1.15.8',()=>load('./majalis-voting-fix-v1157.js?v=1.15.8'))));
})();
