...
if(descriptor?.set&&!window.__majalisBaseCacheRewriteV11510){
  ...
  window.__majalisBaseCacheRewriteV11510=true;
}
...
load('./majalis-decision-card-v1151.js?v=1.15.10',()=>load('./majalis-decision-result.js?v=1.15.10',()=>load('./majalis-voting-fix-v1153.js?v=1.15.10',()=>load('./majalis-voting-fix-v1157.js?v=1.15.10'))));
})();
