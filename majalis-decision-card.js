...
load('./majalis-decision-card-v1151.js?v=1.15.1',()=>load('./majalis-decision-result.js?v=1.15.3',()=>load('./majalis-voting-fix-v1153.js?v=1.15.3',()=>load('./majalis-voting-fix-v1156.js?v=1.15.6'))));
})();
