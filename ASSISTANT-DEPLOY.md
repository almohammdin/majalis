...
مجلد `functions` يحوي تكامل OpenAI السابق فقط، ولا يستخدمه إصدار `v1.14.0`.

الإصدار الحالي للواجهة والمساعد: `v1.14.0`.
GitHub Pages ينشر المشروع كموقع ثابت عبر ملف `.nojekyll` في جذر المستودع.
