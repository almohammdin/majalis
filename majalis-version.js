...
if(scriptSrc?.set&&!window.__majalisVersionCacheRewrite11510){
  Object.defineProperty(HTMLScriptElement.prototype,'src',{...scriptSrc,set(value){let next=String(value||'');if(next.includes('majalis-')&&/[?&]v=1\.15\.(?:7|8|9)(?:&|$)/.test(next))next=next.replace(/([?&]v=)1\.15\.(?:7|8|9)(?=&|$)/,'$1'+VERSION);scriptSrc.set.call(this,next)}});
  window.__majalisVersionCacheRewrite11510=true;
}
