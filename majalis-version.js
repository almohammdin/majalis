...
if(scriptSrc?.set&&!window.__majalisVersionCacheRewrite11511){
  Object.defineProperty(HTMLScriptElement.prototype,'src',{...scriptSrc,set(value){let next=String(value||'');if(next.includes('majalis-')&&/[?&]v=1\.15\.(?:7|8|9|10)(?:&|$)/.test(next))next=next.replace(/([?&]v=)1\.15\.(?:7|8|9|10)(?=&|$)/,'$1'+VERSION);scriptSrc.set.call(this,next)}});
  window.__majalisVersionCacheRewrite11511=true;
}
